...
export class NT4_Client {
    ...
    private latency_us: number | null = null;
    ...
    */
    ...
    getLatencyMs(): number | null {
        if (this.latency_us === null) {
            return null;
        } else {
            return this.latency_us / 1000.0;
        }
    }
    ...
    private ws_handleReceiveTimestamp(
        ...
        this.latency_us = rtt / 2.0;

        let serverTimeAtRx = serverTimestamp + this.latency_us;
